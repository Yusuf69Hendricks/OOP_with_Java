public class TestUberService {
    ...
    public static class UberService{
         ...
         public double calculateFare(double minutes, double distance) {
             double fare = 0.0;
             fare = (minutes*this.costPerMinute + distance*this.costPerKilometre + this.baseFare);
             return fare;
         }


         /* Getters and Setters */
         public void setDetails(String name, int costPerMinute,
                                int costPerKilometre, int baseFare,
                                int cancellationFee) {
             this.setName(name);
             this.setCostPerMinute(costPerMinute);
             this.setCostPerKilometre(costPerKilometre);
